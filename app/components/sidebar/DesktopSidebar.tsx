...
export default function DesktopSidebar({ currentUser }: DesktopSidebarProps) {
    ...
    return (
        <>
            ...
            <div className='hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:w-20 xl:px-6 lg:bg-white lg:border-r-[1px] lg:border-gray-200 lg:pb-4 lg:flex lg:flex-col justify-between'>
